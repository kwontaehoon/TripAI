            ...
            <div key={day.day} data-oid="zg-:5-w">
              ...
              >
                <div data-oid="mu3q2o8">
                  ...
                  <p className="text-sm text-gray-600" data-oid="w62cdp6">
                    {day.subtitle}
                  </p>
                </div>
                <div
                  ...
                  data-oid="1x_lonx"
                >
                  <div data-oid="3wng05s">약 {day.total_distance}</div>
                  <div data-oid="wr8bb5:">약 {day.total_time}</div>
                </div>
              </div>
              ...
              {day.author_note && (
                ...
                >
                  ...
                  <p className="text-sm text-green-600" data-oid="pj:0d:j">
                    {day.author_note}
                  </p>
                </div>
              )}
              ...
              <div className="space-y-6" data-oid="328h.u7">
                {day.board_places.map((place, index) => (
                  <div key={place.id} className="relative" data-oid="qe8kqsn">
                    {/* Timeline Line */}
                    ...
                    <div className="flex space-x-4" data-oid="a:ep1j3">
                      ...
                      {/* Content */}
                      <div className="flex-1 min-w-0" data-oid="67w-o:-">
                        <div
                        ...
                        <div
                          ...
                          data-oid="x2xebek"
                        >
                          <div className="flex items-center" data-oid="bgetj9a">
                            <MapPin
                              className="w-4 h-4 mr-1 flex-shrink-0"
                              data-oid="7mfa5ms"
                            />

                            <span className="truncate" data-oid="ul-prch">
                              {place.location}
                            </span>
                          </div>
                          <div className="flex items-center" data-oid="hawcgwt">
                            <Clock
                              className="w-4 h-4 mr-1 flex-shrink-0"
                              data-oid="xha-bc_"
                            />
                        ...
                        <If isTrue={!place.review}>
                          <div className="flex items-center" data-oid="abv.d4-">
                            <Star
                              className="w-4 h-4 text-yellow-400 mr-1"
                              data-oid="cml037d"
                            />

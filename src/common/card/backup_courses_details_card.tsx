            ...
            >
              ...
              <div className="space-y-6" data-oid="ixfy:al">
                {day.places.map((place, index) => (
                  <div key={place.id} className="relative" data-oid="_lo9t8o">
                    {/* Timeline Line */}
                    ...
                    <div className="flex space-x-4" data-oid="sc.fx_l">
                      ...
                      <div className="flex-1 min-w-0" data-oid="j40foyt">
                        ...
                        <div
                          ...
                          data-oid="hkg3axr"
                        >
                          <div className="flex items-center" data-oid="rhwdh2f">
                            <MapPin
                          ...
                          <div className="flex items-center" data-oid="i7qgxz.">
                            <Clock
                              className="w-4 h-4 mr-1 flex-shrink-0"
                              data-oid="qe8ton9"
                            />
                            ...
                            >
                              {place.tips.map((tip, tipIndex) => (
                                <li
                                  ...
                                  data-oid="j:e.i6s"
                                >
                                  <span className="mr-2" data-oid="zwck3b-">
                                    •
                                  </span>
                        ...
                        <div
                          ...
                          data-oid="mx4u9oo"
                        >
                          <div className="flex items-center" data-oid="x0pfse7">
                            <Star

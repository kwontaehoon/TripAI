...
// testPageNation
export const getTestPageNation = (params: number) =>
  clientAxios.get(ACCOUNT_URL.testPageNation, {
    params: {
      page: params,
    },
  })
...
// urlCheck
export const postUrlCheck = (params: object) =>
  clientAxios.post(API_URL.urlCheck, params)

// urlRegister
export const postUrlRegister = (params: object) =>
  clientAxios.post(API_URL.urlRegister, params)

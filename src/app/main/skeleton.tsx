...
export default function HomeSkeleton() {
    ...
    return (
        ...
        >
            ...
            >
                <div className="mb-12 w-full lg:w-[700px]" data-oid="o14r9mp">
                    ...
                    >
                        <div data-oid="x4my206">
                            <div className="flex items-center space-x-2 mb-4" data-oid="ctj36se">
                                <Sparkles className="w-6 h-6 text-blue-600" data-oid="zn:4747" />
                                <span
                            ...
                            <div className="relative mb-6" data-oid="qh-z068">
                                ...
                                >
                                    ...
                                    <div className="flex items-center space-x-2" data-oid="go1rii8">
                                        <button
                    ...
                    <div className="mb-8" data-oid="7h-z3ao">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4" data-oid="sg.gjic">
                            AI 추천 여행 코스
                        </h3>
                    ...
                    <div className="mb-8" data-oid="adpxl0i">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4" data-oid="e.kyfn-">
                            인기 여행지
                        </h3>
                    ...
                    <div data-oid="ys_vegy">
                        <div className="flex items-center justify-between mb-4" data-oid="9lu9g8x">
                            <h3 className="text-lg font-semibold text-gray-900" data-oid="6gftqrv">
                                여행자들의 생생한 후기
                            </h3>
                            <button
                ...
                <div className="space-y-6 w-full lg:w-[230px]" data-oid="61.cxjv">
                    ...
                    <div
                        ...
                        data-oid="qoztyki"
                    >
                        <div className="flex items-center space-x-2 mb-4" data-oid="oy_-z:h">
                            <div
                                className="w-2 h-2 bg-green-500 rounded-full"
                                data-oid="0:0oli7"
                            ></div>
                            <span className="text-sm font-medium text-gray-900" data-oid="5slrcd4">
                                실시간
                            </span>
                        </div>
                        <div
                        ...
                        <div className="space-y-3" data-oid="m:0uuqm">
                            ...
                            <div className="pt-3 border-t !border-gray-100" data-oid="o6buhs8">
                                <div
            ...
            {/* Footer Skeleton */}
            <div className="bg-white border-t !border-gray-200 mt-12" data-oid="lygm5ia">
                <div className="max-w-6xl mx-auto px-4 py-8" data-oid="1:lidn1">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8" data-oid="b5tj974">
                        {[1, 2, 3, 4].map((i) => (
                    ...
                    <div className="border-t !border-gray-200 mt-8 pt-8" data-oid="o::gmz8">
                        <div

...
export default function SearchPage() {
  ...
  const filteredResults = searchResults.filter((result) => {
    ...
    if (selectedFilter === "사용자 코스" && result.type === "user-post")
      return true
            ...
            >
              ...
              {searchQuery && (
                <div className="text-sm text-gray-600" data-oid="53ot0fm">
                  &apos;{searchQuery}&apos; 검색 결과 {filteredResults.length}개
                </div>
              )}
            </div>
                  ...
                  <div className="p-4 sm:p-6" data-oid="5m0nh56">
                    ...
                    {result.type === "user-post" && result.author && (
                      <div
                        ...
                        data-oid="3rdmb_1"
                      >
                        <span className="text-lg sm:text-xl" data-oid="313ycoo">
                        ...
                        <div className="min-w-0" data-oid="n8nfu_h">
                          ...
                          <div
                            ...
                            data-oid="i.:.ldz"
                          >
                            게시글 {result.author.posts}개 • {result.createdAt}
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    >
                      ...
                      >
                        ...
                        <span data-oid="itd7fcq">{result.places}개 장소</span>
                      </div>
                      <div
                        className="flex items-center text-gray-600"
                        data-oid="ot8z_z4"
                        ...
                        {result.highlights
                          ...
                          .map((highlight, index) => (
                            ...
                            >
                              {highlight}
                              {index <
                                Math.min(result.highlights.length, 3) - 1 &&
                                " • "}
                            </span>
                          ))}

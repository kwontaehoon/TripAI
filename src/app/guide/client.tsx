    ...
    "getting-started": {
      ...
      content: [
        ...
        },
        {
          ...
          title: "프로필 설정",
          description:
            "여행 취향과 관심사를 설정하여 더 정확한 추천을 받으세요.",
          tips: [
            "선호하는 여행 스타일을 선택하세요",
            "관심 지역을 등록해보세요",
          ],
    ...
    "search-guide": {
      ...
      content: [
        ...
        },
        {
          ...
          title: "필터 활용",
          description:
            "검색 결과를 세부 조건으로 필터링하여 원하는 코스를 찾으세요.",
      ...
      content: [
        {
          ...
          title: "AI 맞춤 코스",
          description:
            "개인의 취향과 여행 이력을 분석하여 최적의 코스를 추천합니다.",
        ...
        },
        {
          ...
          title: "실시간 추천",
          description:
            "현재 날씨, 계절, 이벤트 정보를 반영한 실시간 추천을 제공합니다.",
        ...
        },
        {
          ...
          title: "코스 최적화",
          description:
            "이동 경로와 시간을 고려하여 효율적인 코스를 제안합니다.",
      ...
      content: [
        {
          ...
          title: "즐겨찾기 활용",
          description:
            "마음에 드는 코스는 즐겨찾기에 저장하여 나중에 쉽게 찾아보세요.",
        ...
        },
        {
          ...
          title: "오프라인 저장",
          description:
            "여행지에서 인터넷이 불안정할 때를 대비해 코스를 미리 저장하세요.",

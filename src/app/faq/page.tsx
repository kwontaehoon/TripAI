...
export default function FAQPage() {
    ...
    const categories = [
        { name: '전체', icon: <BookOpen className="w-5 h-5" data-oid="ux3vncd" />, count: 24 },
        { name: '계정/회원가입', icon: <Users className="w-5 h-5" data-oid=":pps6-e" />, count: 8 },
        { name: '여행 코스', icon: <Globe className="w-5 h-5" data-oid="3cqnh::" />, count: 6 },
        {
            name: '결제/환불',
            icon: <CreditCard className="w-5 h-5" data-oid="i0dawhf" />,
            count: 5,
        },
        { name: '앱 사용법', icon: <Settings className="w-5 h-5" data-oid=":y1gs53" />, count: 3 },
        {
            name: '보안/개인정보',
    ...
    const faqData: FAQItem[] = [
        {
            ...
            answer: '홈페이지 우측 상단의 "회원가입" 버튼을 클릭하시거나, 모바일 앱에서 "계정 만들기"를 선택하세요. 이메일 주소와 비밀번호를 입력하시면 간단하게 가입할 수 있습니다. 소셜 로그인(구글, 카카오, 네이버)도 지원합니다.',
        ...
        },
        {
            ...
            answer: '로그인 페이지에서 "비밀번호 찾기"를 클릭하세요. 가입 시 사용한 이메일 주소를 입력하시면 비밀번호 재설정 링크를 보내드립니다. 이메일을 확인하시고 새로운 비밀번호를 설정하세요.',
        ...
        },
        {
            ...
            answer: 'TripAI는 사용자의 선호도, 여행 기간, 예산, 동행자 정보 등을 분석하여 개인 맞춤형 여행 코스를 생성합니다. 실시간 날씨, 교통 상황, 현지 이벤트 정보도 고려하여 최적의 일정을 제안합니다.',
        ...
        },
        {
            ...
            answer: '네, 가능합니다. 추천받은 코스에서 원하지 않는 장소를 삭제하거나, 새로운 장소를 추가할 수 있습니다. 또한 일정 순서를 변경하거나 각 장소에서의 체류 시간도 조정할 수 있습니다.',
        ...
        },
        {
            ...
            answer: '신용카드, 체크카드, 계좌이체, 간편결제(카카오페이, 네이버페이, 페이코) 등 다양한 결제 방법을 지원합니다. 해외 결제의 경우 PayPal과 Stripe를 통해 안전하게 처리됩니다.',
        ...
        },
        {
            ...
            answer: '프리미엄 플랜 구매 후 7일 이내에는 100% 환불이 가능합니다. 단, 이미 프리미엄 기능을 사용한 경우에는 사용량에 따라 부분 환불될 수 있습니다. 환불 신청은 고객센터를 통해 접수해 주세요.',
        ...
        },
        {
            ...
            answer: '네, 가능합니다. 여행 코스를 미리 다운로드하시면 인터넷 연결 없이도 지도와 상세 정보를 확인할 수 있습니다. 단, 실시간 정보(교통, 날씨 등)는 온라인 상태에서만 업데이트됩니다.',
        ...
        },
        {
            ...
            answer: 'TripAI는 개인정보보호법에 따라 사용자의 개인정보를 안전하게 보호합니다. 모든 데이터는 암호화되어 저장되며, 제3자와 공유되지 않습니다. 자세한 내용은 개인정보처리방침을 참고해 주세요.',
        ...
        <div className="min-h-screen bg-gray-50" data-oid="7241_fd">
            ...
            >
                <div className="max-w-4xl mx-auto text-center px-6" data-oid="hgeazah">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6" data-oid="4d85jlv">
                        자주 묻는 질문
                    </h1>
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto" data-oid="knhn.z4">
                        TripAI 사용 중 궁금한 점이 있으시나요? 가장 자주 묻는 질문들에 대한 답변을
                        확인해보세요.
                    </p>
                </div>
            </section>
            ...
            <section className="py-8 bg-gray-100" data-oid="w:nimid">
                <div className="max-w-6xl mx-auto px-6" data-oid="4czzend">
                    <div className="flex flex-wrap gap-4 justify-center" data-oid="w0w4i.i">
